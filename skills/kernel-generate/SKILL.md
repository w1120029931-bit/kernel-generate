...
13. 优先使用 `custom_op_contract.md` 指定的测试和性能测试约定。如果该文件没有规定，则从当前任务上下文中推断，并把新发现的具体仓库规则补充到该文件。
14. 只有当关键语义、接口要求或性能测试基准无法从代码、文档和 `custom_op_contract.md` 中推断，并且会阻塞实现或验证时，才向用户提问。
